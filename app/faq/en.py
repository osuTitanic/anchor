...
strings = {
    ...
    "avatar-change": "You can change your avatar [https://osu.titanic.sh/account/settings/profile#avatar here].",
    ...
    "bug": "If you think you've found a bug, report it [https://osu.titanic.sh/forum/18 here]. Just make sure no one else posted your problem beforehand.",
    ...
    "country-ranking": "View the various [https://osu.titanic.sh/rankings/osu/country Country Ranking] scoreboards here.",
    ...
    "disable-this": "Toggles are rarely added for features. You can still request one to be added via the [https://osu.titanic.sh/forum/6 Feature Requests subforum], though.",
    ...
    "download": "You can download more beatmaps [https://osu.titanic.sh/beatmapsets here] or beatmap packs [https://osu.titanic.sh/beatmapsets/packs here].\nIn case you don't know how to import them, you can read [http://i.imgur.com/kpX2N3m.jpg this] to find out!",
    ...
    "english": "#osu is for general discussion about anything which doesn't have a dedicated channel.\nYes, this does include anime/manga. And trains.",
    ...
    "feature": "If you have an idea for this game, post it in the [https://osu.titanic.sh/forum/6 Feature Requests] subforum.\nMake sure you have read the [https://osu.ppy.sh/forum/t/454006 forum guidelines] first!",
    ...
    "friends-list": "To see a list of your online friends in-game, press F9 then change the filter on top to Friends.\nYou can also see the full list of your friends [https://osu.titanic.sh/account/settings/friends here]. Make sure you are logged in.",
    ...
    "gmt": "The [https://osu.titanic.sh/g/4 Global Moderation Team], for short GMT, is a group of users that help run osu!. They have red names in chat and green names on the forums. \nThese guys help moderate the forum and chat.",
    ...
    "hacked": "If you believe you have been hacked, please email support@titanic.sh to follow up.\nFailure to do so may result in account termination.",
    "hard": "Git gud, scrub.",
    ...
    "how-to-gmt": "Global Moderators are hand-picked depending on how much they have contributed to the community.\nFor more details, read the team's wiki page: [https://osu.titanic.sh/wiki/en/People/Administrators Administrators]",
    ...
    "irc": "IRC server: irc.titanic.sh\nPassword: https://osu.titanic.sh/account/settings/security",
    ...
    "status": "For osu! system status updates, please refer to [https://status.titanic.sh status page].",
    ...
    "welcome": "Welcome to osu!Titanic! If you have a problem or question that needs answering, ask the nice people in #osu! Keep the chat friendly and have fun! :D",
