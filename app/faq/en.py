...
strings = {
    ...
    "avatar-change": "You can change your avatar [https://osu.titanic.sh/account/profile#avatar here].",
    ...
    "friends-list": "To see a list of your online friends in-game, press F9 then change the filter on top to Friends.\nYou can also see the full list of your friends [https://osu.titanic.sh/account/friends here]. Make sure you are logged in.",
    ...
    "irc": "IRC server: irc.titanic.sh\nPassword: https://osu.titanic.sh/account/security",
