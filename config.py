...
POSTGRES_POOL_ENABLED = eval(os.environ.get('POSTGRES_POOL_ENABLED', 'True').capitalize())
POSTGRES_POOL_SIZE = int(os.environ.get('POSTGRES_POOL_SIZE', 10))
POSTGRES_POOL_SIZE_OVERFLOW = int(os.environ.get('POSTGRES_POOL_SIZE_OVERFLOW', 30))
POSTGRES_POOL_PRE_PING = eval(os.environ.get('POSTGRES_POOL_PRE_PING', 'True').capitalize())
POSTGRES_POOL_RECYCLE = int(os.environ.get('POSTGRES_POOL_RECYCLE', 900))
POSTGRES_POOL_TIMEOUT = int(os.environ.get('POSTGRES_POOL_TIMEOUT', 15))
